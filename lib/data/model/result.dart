import 'package:unsplash_viewer_flutter/data/app_error.dart';
...
abstract class Result<T> with _$Result<T> {
  ...
  void ifSuccess<TResult extends Object?>(TResult Function(T data) body) {
    maybeWhen(
  ...
  void ifFailure<TResult extends Object?>(TResult Function(AppError e) body) {
    maybeWhen(
      failure: (e) => body(e),
      orElse: () {
        // no-op
